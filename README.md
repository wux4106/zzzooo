# 官网  
## <a href="https://zzzooo.top/">前往官网</a>   
# 目录  
[简介](#简介)  
[通知](#通知)  
[防失联](#防失联)  
...
## tg下载  
<a href="https://telegram.org/">下载地址(外网访问)</a>   
ios苹果商店下载搜索：telegram  
下载好后,打开外网,用自己手机号码注册好即可
假如自己接受不到验证码,可以去接码平台接码  
<a href="https://51id.net/buy/10">前往接码平台</a>   
...
## 安卓续费教程  
点击箭头位置  
![](/image/AndroidX/1.png)  
把之前的订阅右滑删除  
![](/image/AndroidX/2.png)  
新买的订阅复制好点击＋号  
![](/image/AndroidX/3.png)  
![](/image/AndroidX/4.png)  
，将您收到的 订阅地址 粘贴到文本框中。点击「确定」  
![](/image/AndroidX/5.png)  
这里「自动更新」后面开关必须打开  
点击「确定并升级」就可以导入最新的shejimao接入点信息并自动更新了  
![](/image/AndroidX/6.png)  
ShadowsocksR 应用程序显示「处理中」。这可能需要一小段时间，具体根据网络情况而定  
注意：如果刚才您没有删除默认「FreeSSR-public」订阅列表，就点“确定并升级”，那么会一直处于“处理中”  
